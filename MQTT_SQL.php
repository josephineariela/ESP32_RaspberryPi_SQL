...
$mqtt_id = "hhaqsitb";                   // set your username
$mqtt_pass = "MP7TFv0i040Q";                   // set your password
$client_id = "Growth_Chamber"; // make sure this is unique for connecting to sever - you could use uniqid()
...
if ($mqtt->connect(true, NULL, $mqtt_id, $mqtt_pass)) {
	if ($result = $conn->query($sql)) {
        while ($row = $result->fetch_assoc()) {
            ...
            $mqtt->publish("ActTemp", $row_temp, 0);
